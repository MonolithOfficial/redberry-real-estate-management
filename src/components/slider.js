...
const CustomSlider = ({ items }) => {
    ...
    var settings = {
        ...
        arrows: true,
        adaptiveHeight: true,
        draggable: false, // NO DRAG IS BETTER.
    };
                ...
                {items.map((item, index) => (
                    <div key={index} className='slider-card' onClick={() => handleRouting(item.id)}>
                        ...
                        <div className='description-holder'>
                            <p className='pricepoint'>{priceFormatterSpace(item.price)} ₾</p>
                            <p className='address'>{item.city.name}, {item.address}</p>
                        </div>
